...
if(!isset($_GET['confirm']) || $_GET['confirm'] != 'true') {
	...
	print "<p><a href=\"deleteOrphan.php?mac={$mac}&confirm=true\">I UNDERSTAND THAT BY CLICKING THIS LINK I WILL BE PERMANENTLY DELETING SENSOR {$mac} FROM THE SYSTEM!</a></p>";
